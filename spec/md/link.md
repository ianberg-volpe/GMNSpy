...
| :-------------------------------- | --------- | -------- | -------------- | :------------------------------------------------------------------------------------------- |
| [link_id](#link_id)               | `any`     | Required | cannot be null | [link](link-properties-link_id.md "spec/link.schema.json#/properties/link_id")               |
...
| [from_node_id](#from_node_id)     | `any`     | Required | cannot be null | [link](link-properties-from_node_id.md "spec/link.schema.json#/properties/from_node_id")     |
| [to_node_id](#to_node_id)         | `any`     | Required | cannot be null | [link](link-properties-to_node_id.md "spec/link.schema.json#/properties/to_node_id")         |
