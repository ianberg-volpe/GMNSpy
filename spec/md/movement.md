...
| :------------------------------ | --------- | -------- | -------------- | :----------------------------------------------------------------------------------------------------- |
| [mvmt_id](#mvmt_id)             | `any`     | Required | cannot be null | [movement](movement-properties-mvmt_id.md "spec/movement.schema.json#/properties/mvmt_id")             |
| [node_id](#node_id)             | `any`     | Required | cannot be null | [movement](movement-properties-node_id.md "spec/movement.schema.json#/properties/node_id")             |
| [name](#name)                   | `any`     | Optional | cannot be null | [movement](movement-properties-name.md "spec/movement.schema.json#/properties/name")                   |
| [ib_link_id](#ib_link_id)       | `any`     | Required | cannot be null | [movement](movement-properties-ib_link_id.md "spec/movement.schema.json#/properties/ib_link_id")       |
...
| [ob_link_id](#ob_link_id)       | `any`     | Required | cannot be null | [movement](movement-properties-ob_link_id.md "spec/movement.schema.json#/properties/ob_link_id")       |
...
| [type](#type)                   | `string`  | Required | cannot be null | [movement](movement-properties-type.md "spec/movement.schema.json#/properties/type")                   |
