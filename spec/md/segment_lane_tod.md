...
| :------------------------------------------ | --------- | -------- | -------------- | :----------------------------------------------------------------------------------------------------------------------------------------- |
| [segment_lane_tod_id](#segment_lane_tod_id) | `any`     | Required | cannot be null | [segment_lane_tod](segment_lane_tod-properties-segment_lane_tod_id.md "spec/segment_lane_tod.schema.json#/properties/segment_lane_tod_id") |
| [segment_lane_id](#segment_lane_id)         | `any`     | Required | cannot be null | [segment_lane_tod](segment_lane_tod-properties-segment_lane_id.md "spec/segment_lane_tod.schema.json#/properties/segment_lane_id")         |
...
| [lane_num](#lane_num)                       | `integer` | Required | cannot be null | [segment_lane_tod](segment_lane_tod-properties-lane_num.md "spec/segment_lane_tod.schema.json#/properties/lane_num")                       |
